...
\title{Theano at a Glance: A Framework for Machine Learning}
...
\item \bf{(Not a machine learning framework/software)}
  \end{itemize}
  \item \{...\}: Many libraries build on top of Theano
...
\begin{frame}{High level (2)}
  ...
  \item blocks
  \item lasagne
  \item sklearn-theano: combine Theano and sklearn.
  \item PyMC 3
  \item theano-rnn
  \item Morb
  \item ...
...
\begin{frame}{Theano 0.8 (1)}
\begin{tiny}Relesed 21th of March, 2016\end{tiny}
...
\begin{frame}{Theano 0.8 (2)}

Highlights:
\begin{itemize}
\item Better convolution on CPU and GPU. (CorrMM, cudnn, 3d conv, more parameter)
\item More pooling parameter supported
...
\begin{frame}{What's missing?}
  \begin{itemize}
    ...
    \item Lacks symbolic or symbolic differentiation
...
\begin{frame}{Description (2)}
  ...
  \begin{itemize}
    \item symbolic differentiation and R op (Hessian Free Optimization)
...
\item GTC2016 session:
  \begin{itemize}
  \item S6116 - Hands-on Lab: Deep Learning with the Theano Python Library
  \end{itemize}
